...
[Files]
Source: "Main\Output\{#SetupSetting("AppName")}.x64.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "Main\Output\Languages\*.lng"; DestDir: "{app}\Languages"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: "{group}\{#SetupSetting("AppName")}"; Filename: "{app}\{#SetupSetting("AppName")}.x64.exe"
...
Name: "{commondesktop}\{#SetupSetting("AppName")}"; Filename: "{app}\{#SetupSetting("AppName")}.x64.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#SetupSetting("AppName")}"; Filename: "{app}\{#SetupSetting("AppName")}.x64.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\{#SetupSetting("AppName")}.x64.exe"; Description: "{cm:LaunchProgram,{#SetupSetting("AppName")}}"; Flags: nowait postinstall skipifsilent shellexec
